...
/**
 * Create a circuit breaker instance for URL imports
 * @param serviceName - Name of the service for logging (e.g., "AppStandard CalendarURLImport")
 */
export function createUrlImportCircuitBreaker(
	serviceName: string,
): CircuitBreaker {
	return new CircuitBreaker({
		failureThreshold: 5,
		resetTimeout: 60000, // 1 minute
		name: `${serviceName}URLImportCircuitBreaker`,
	});
}
