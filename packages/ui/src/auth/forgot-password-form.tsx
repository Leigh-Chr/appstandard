/**
 * Shared Forgot Password Form Component
 * Parametric auth form for all AppStandard suite apps
 */
...
export interface ForgotPasswordFormProps extends BaseAuthFormProps {
