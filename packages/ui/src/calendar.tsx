...
function Calendar({
	...
	return (
		<DayPicker
			...
			className={cn(
				"group/calendar bg-background p-3 [--cell-size:--spacing(11)] sm:[--cell-size:--spacing(8)] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
			...
			classNames={{
				...
				dropdown_root: cn(
					"relative rounded-md border border-input shadow-(--shadow-0) has-focus:border-ring has-focus:ring-[3px] has-focus:ring-ring/50",
