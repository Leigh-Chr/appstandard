...
import { createLogger, t } from "@appstandard/api-core";
import { TRPCError } from "@trpc/server";

const logger = createLogger("Contacts Rate Limit");
...
/**
 * Rate limit for import from URL (10 per hour)
 */
export const importUrlRateLimit = createRateLimitMiddleware(
	10,
	3600000, // 1 hour
	"import-url",
);
