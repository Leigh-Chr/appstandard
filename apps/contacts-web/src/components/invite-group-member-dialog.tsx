...
interface ContactInviteGroupMemberDialogProps {
	groupId: string;
	open: boolean;
	onOpenChange: (open: boolean) => void;
}

function ContactInviteGroupMemberDialog({
	groupId,
	open,
	onOpenChange,
}: ContactInviteGroupMemberDialogProps) {
...
export { ContactInviteGroupMemberDialog as InviteGroupMemberDialog };
