import type { AppRouter } from "@appstandard/api/routers/index";
...
const serverUrl = envServerUrl || "http://localhost:3000";

// Warn in development if VITE_SERVER_URL is not configured
if (import.meta.env.DEV && !envServerUrl) {
	console.warn(
		"[AppStandard Calendar] VITE_SERVER_URL not configured. Using default: http://localhost:3000\n" +
			"Create apps/calendar-web/.env with:\n" +
