...
interface TaskGroupMembersListProps {
	groupId: string;
	isOwner: boolean;
	currentUserId?: string | undefined;
}

function TaskGroupMembersList({
	groupId,
	isOwner,
	currentUserId,
}: TaskGroupMembersListProps) {
	...
	return (
		<GroupMembersList
			labels={{ entityPlural: "task lists" }}
			groupId={groupId}
			isOwner={isOwner}
...
export { TaskGroupMembersList as GroupMembersList };
