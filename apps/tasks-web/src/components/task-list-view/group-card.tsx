/**
 * Task List Group Card Component
 * Displays a group of task lists with actions (export, share, edit, delete)
 */
...
interface TaskListGroupCardProps {
	group: {
		id: string;
		name: string;
					...
					<div className="min-w-0 flex-1 pr-8">
						...
						<CardDescription className="mt-1.5">
							{group.description ? (
								...
								<span>
									{group.taskListCount} task list
									{group.taskListCount !== 1 ? "s" : ""}
								</span>
							)}
							{group.description && (
...
export { TaskListGroupCard as GroupCard };
