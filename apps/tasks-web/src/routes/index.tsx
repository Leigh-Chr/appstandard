...
export const Route = createFileRoute("/")({
	...
	head: () => ({
		meta: [
			...
			{ property: "og:site_name", content: "AppStandard Tasks" },
			// Twitter Card
				...
				<div className="container mx-auto px-4 py-16 sm:py-24 md:py-32">
					<div className="mx-auto max-w-3xl text-center">
						...
						<p className="fade-in slide-in-from-bottom-5 mx-auto mb-10 max-w-2xl animate-in text-body-large text-muted-foreground duration-1000">
							Create, organize, and track your tasks in just a few clicks.
							Export to{" "}
							...
							, and any app supporting{" "}
							<span className="font-medium text-foreground">VTODO</span>.
						</p>
				...
				<div className="container mx-auto px-4 py-20 sm:py-24">
					<div className="mx-auto mb-16 max-w-2xl text-center">
						...
						<p className="text-muted-foreground">
							Powerful tools to manage your tasks, without complexity.
						</p>
					</div>
					...
					<div className="mx-auto grid max-w-5xl gap-4 sm:grid-cols-2 lg:grid-cols-3">
						<BentoCard
							icon={ListChecks}
							title="Task Lists"
							description="Create multiple task lists to organize your work and life."
							delay={0}
						/>
						<BentoCard
							icon={FolderSync}
							title="Smart Sync"
							description="Synchronize tasks across all your devices seamlessly."
							delay={50}
						/>
						<BentoCard
							icon={Download}
							title="Universal Export"
							description="Export to Google Calendar, Apple Reminders, and any VTODO app."
							delay={100}
						/>
						<BentoCard
							icon={Tags}
							title="Priority & Labels"
							description="Set priorities and use labels to organize your tasks."
							delay={150}
						/>
						<BentoCard
							icon={Search}
							title="Quick Search"
							description="Find tasks by title, description, status, or due date."
							delay={200}
						/>
						<BentoCard
							icon={Zap}
							title="Offline Mode"
							description="Works offline—manage your tasks anywhere, anytime."
							delay={250}
						/>
					</div>
				</div>
			...
			>
				...
				<div className="container mx-auto px-4 py-20 sm:py-24">
					<div className="mx-auto mb-12 max-w-2xl text-center">
						...
						<p className="text-muted-foreground">
							Three simple steps to master your tasks.
						</p>
					</div>
					...
					<div className="mx-auto grid max-w-4xl gap-8 md:grid-cols-3">
						<StepCard
							...
							description="Create a new task list or import existing tasks."
							delay={0}
						/>
						<StepCard
							number="02"
							title="Organize freely"
							description="Add tasks, set due dates, priorities, and labels."
							delay={100}
						/>
						<StepCard
							number="03"
							title="Track & complete"
							description="Check off completed tasks and track your progress."
							delay={200}
						/>
					</div>
				</div>
						...
						<div className="grid gap-6 md:grid-cols-2">
							...
							<article className="group relative overflow-hidden rounded-2xl border bg-card p-8 transition-all duration-200 hover:border-muted-foreground/20 hover:shadow-lg">
								...
								<p className="mb-6 text-body text-muted-foreground">
									Use AppStandard Tasks immediately without creating an account.
							...
							<article className="group relative overflow-hidden rounded-2xl border-2 border-primary/20 bg-card p-8 transition-all duration-200 hover:border-primary/40 hover:shadow-lg">
								...
								<p className="mb-6 text-body text-muted-foreground">
									Create a free account to sync your tasks across all your
									devices.
								</p>
								<ul className="space-y-3 text-body text-muted-foreground">
									<li className="flex items-center gap-3">
										<CheckCircle
											...
											aria-hidden="true"
										/>
										<span>Up to 100 task lists</span>
									</li>
									<li className="flex items-center gap-3">
										<CheckCircle
											className="size-4 text-primary"
											aria-hidden="true"
										/>
										<span>2,000 tasks per list</span>
									</li>
									<li className="flex items-center gap-3">
										<CheckCircle
											className="size-4 text-primary"
