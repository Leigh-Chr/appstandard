...
export const Route = createRootRouteWithContext<RouterAppContext>()({
	...
	head: () => ({
		meta: [
			{
				title: "AppStandard Tasks - Task management simplified",
			},
			{
				name: "description",
				content:
			...
			{
				property: "og:title",
				content: "AppStandard Tasks - Manage your tasks simply",
			},
			{
				property: "og:description",
				content:
					"Create, organize, and track your todos in a few clicks. Free and open-source PWA application.",
			},
			{
				property: "og:image",
		...
		links: [
			...
			{
				rel: "preconnect",
				href: "https://api-tasks.appstandard.io",
			},
		],
		scripts: [
			{
		...
		<>
			...
			<AppProvider config={APP_CONFIG}>
				<ThemeProvider
					...
					storageKey="appstandard-tasks-theme"
				>
					...
					<TourProvider storageKeyPrefix="appstandard-tasks-">
