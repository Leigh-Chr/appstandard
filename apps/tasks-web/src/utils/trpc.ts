import type { AppRouter } from "@appstandard-tasks/api";
...
const serverUrl = envServerUrl || "http://localhost:3002";

// Warn in development if VITE_SERVER_URL is not configured
if (import.meta.env.DEV && !envServerUrl) {
	console.warn(
		"[AppStandard Tasks] VITE_SERVER_URL not configured. Using default: http://localhost:3002\n" +
			"Create apps/tasks-web/.env with:\n" +
